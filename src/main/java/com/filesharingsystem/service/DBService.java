...
public class DBService {
    ...
    /*GridFS is a file storage specification in MongoDB that allows for the storage and retrieval of large files, such as images, videos, and audio files. */

    public String addFile(MultipartFile upload) throws IOException {

        //define additional metadata
        DBObject metadata = new BasicDBObject();/*To store key value pairs in mongodb */
